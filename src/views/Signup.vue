  ...
  <div class="signup-page mx-auto p-3 w-330">
    ...
    <validate-form @form-submit="onFormSubmit">
      ...
      <div class="mb-3">
        ...
        <validate-input type="text" placeholder="请输入昵称" :rules="nicknameRules" v-model="formData.nickname" />
      </div>
      <div class="mb-3">
      ...
      <div class="mb-3">
        ...
        <validate-input type="password" placeholder="请再次输入密码" :rules="repeatPasswordRules"
